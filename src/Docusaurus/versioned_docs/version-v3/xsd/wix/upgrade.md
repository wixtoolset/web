...
<dl>
  ...
  <dd>None</dd>
  <dt>Children</dt>
  <dd>Choice of elements (min: 0, max: unbounded)<ul><li><a href="../wix/property">Property</a> (min: 0, max: unbounded): Nesting a Property element under an Upgrade element has been deprecated.                             Please nest Property elements in any of the other supported locations.</li><li><a href="../wix/upgradeversion">UpgradeVersion</a> (min: 0, max: unbounded)</li></ul></dd>
  <dt>Attributes</dt>
  <dd>
