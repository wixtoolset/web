...
<dl>
  ...
  <dt>Parents</dt>
  <dd>
    <a href="../thmutil/billboard" class="extension">Billboard</a>, <a href="../thmutil/imagelist" class="extension">ImageList</a>, <a href="../thmutil/page" class="extension">Page</a>, <a href="../thmutil/theme" class="extension">Theme</a></dd>
  <dt>Inner Text</dt>
  <dd>None</dd>
  <dt>Children</dt>
  <dd>None</dd>
  ...
  <dd>
    <table cellspacing="0" cellpadding="0" class="schema">
      ...
      <tr>
        <td>ImageFile</td>
        <td>String</td>
        <td>Relative path to an image file. Mutually exclusive with ImageResource and SourceX and SourceY attributes.</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>ImageResource</td>
        <td>String</td>
        <td>Identifier that references an image resource in the module. Mutually exclusive with ImageFile and SourceX and SourceY attributes.</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>Name</td>
